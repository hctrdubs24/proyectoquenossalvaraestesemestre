	...
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<div>
					<img src="img/abaBarLogin.png">
				</div>
			</td>
			<td class="info_empresa">
				<div>
					<span class="h2">ABARROTES BÁRBARA</span>
					<p>Calle Allende No.4, Col. Miguel Alemán, Comitán de Domínguez, Chiapas</p>
					<p>Teléfono: +52 963 106 07 96</p>
					<p>Email: ababarInfo@gmail.com</p>
				</div>
			</td>
